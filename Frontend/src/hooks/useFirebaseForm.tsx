...
import {InputProps, UseFirebaseForm} from './useFirebaseForm.types'

const formInput: FunctionComponent<InputProps> = ({placeholder, name, text, type, onChange, options}) => (
    <div className="text-center">
        <label htmlFor={name} className="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">{text}</label>
        {type === 'checkbox' ? (
...
const useFirebaseForm: FunctionComponent<UseFirebaseForm> = () => {
